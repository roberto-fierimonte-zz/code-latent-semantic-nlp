...
class GenLatentSemanticStanford(object):

    def __init__(self, z_dim, max_length, vocab_size, embedding_dim, embedder, dist_z, dist_x, nn_kwargs):

        """
        :param z_dim: dimension of the hidden representation
        :param max_length: maximum length of all the sentences
        :param vocab_size: size of the corpus vocabulary
        :param embedding_dim: dimension of the word embedding
        :param embedder: ???
        :param dist_z: distribution for the observed in the generative model
        :param dist_x: distribution for the observed in the generative model
        :param nn_kwargs: params of the generative model
        """
    ...
    def rnn_fn(self):
        ...
        """
        Initialise generative RNN. The network is structured as an Input Layer, followed by
        a variable number of LSTM layers, followed by a simple RNN layer.
        """
